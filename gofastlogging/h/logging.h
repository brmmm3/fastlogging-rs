...
ExtConfig *ext_config_new(CMessageStructEnum structured, int8_t hostname,
...
Logging
logging_new(uint8_t level, const char *domain,
            WriterConfigEnum *configs_ptr, // This is a Vec<WriterConfigEnum>
            uint32_t configs_cnt, ExtConfig *ext_config,
...
int logging_set_encryption(Logging logging, CWriterTypeEnum writer,
