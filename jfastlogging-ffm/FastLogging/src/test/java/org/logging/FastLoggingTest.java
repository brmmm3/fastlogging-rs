...
public class FastLoggingTest extends TestCase {
    ...
    public void testWriterTypeEnum() {
        ...
        assertEquals(3, FastLogging.WriterTypeEnum.Files.getValue());
        assertEquals(4, FastLogging.WriterTypeEnum.Client.getValue());
        assertEquals(5, FastLogging.WriterTypeEnum.Clients.getValue());
        assertEquals(6, FastLogging.WriterTypeEnum.Server.getValue());
        assertEquals(7, FastLogging.WriterTypeEnum.Servers.getValue());
        assertEquals(8, FastLogging.WriterTypeEnum.Callback.getValue());
        assertEquals(9, FastLogging.WriterTypeEnum.Syslog.getValue());
    }
